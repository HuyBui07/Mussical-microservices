...
import { HomeIcon, MusicalNoteIcon, ArrowLeftStartOnRectangleIcon, MagnifyingGlassIcon } from "@heroicons/react/16/solid";
...
export default function SideBar() {
  ...
  return (
    <>
      ...
      <div className="m-2 sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-zinc-800" style={{ borderRadius: '10px' }}>
        ...
        <MagnifyingGlassIcon className="w-8 mx-0"/>
          <span className="text-[15px] ml-4 text-gray-200 font-bold">Explore</span>
        </div>
        {/* Dropdown */}
        <div>
          <div

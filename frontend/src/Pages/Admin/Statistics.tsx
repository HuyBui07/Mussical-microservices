...
import { BarSeriesType, HighlightScope } from "@mui/x-charts";
...
export default function ChartLine() {
  ...
  return (
    <>
      <div
        //only 50% available width for this div
        className="m-2 ml-4 bg-zinc-800 h-[60vh] w-[50%] flex flex-row py-10 px-10"
              ...
              xAxis={[
                {
                  ...
                  valueFormatter: (value: number) => {
                    ...
                    if (value === 1) return `Week 1 (1-7/${currentMonth + 1})`;
                    if (value === 2) return `Week 2 (8-14/${currentMonth + 1})`;
                    if (value === 3)
